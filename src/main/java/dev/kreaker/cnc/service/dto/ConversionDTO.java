...
public class ConversionDTO {
  ...
  public static ConversionDTO fromEntity(AlCatalogTwostep entity) {
    ...
    return ConversionDTO.builder().modulo(entity.getId().getModulo())
        .campo(entity.getId().getCampo()).valor(entity.getId().getValor())
        .cadena(entity.getId().getCadena()).domain(entity.getDomain()).status(entity.getStatus())
        .createdAt(entity.getCreatedAt()).createdBy(entity.getCreatedBy())
        .modifiedAt(entity.getModifiedAt()).modifiedBy(entity.getModifiedBy()).build();
  }
  ...
  public String getCadenaDisplay() {if(cadena==null){return"";}return switch(cadena){case 1->"GNC";case 2->"Arca";default->String.valueOf(cadena);};}
}
