...
public class ExportImportController {
	...
	public ResponseEntity<byte[]> exportCatalogTemplateToCsv() {
		try {
			...
			String filename = "catalog_import_template_" + LocalDateTime.now().format(FILE_DATE_FORMAT) + ".csv";
	...
	public ResponseEntity<byte[]> exportCatalogTemplateToExcel() {
		try {
			...
			String filename = "catalog_import_template_" + LocalDateTime.now().format(FILE_DATE_FORMAT) + ".xlsx";
